...
["dart.async", "dart:async", , P, {
  ...
  _SyncCompleter: {
    ...
    }, "complete$0", "call$1", "call$0", "get$complete", 0, 2, 14, 4]
  },
  _Future: {
...
["dart.dom.html", "dart:html", , W, {
  ...
  CssStyleDeclarationBase: {
    ...
    set$transitionDelay: function(receiver, value) {
      ...
      this.setProperty$3(receiver, H.S(t1) + "transition-delay", value, "");
    },
...
["", "main.dart", , F, {
  ...
  main: [function() {
    var frame, t1;
    frame = F.BeforeAndAfterPictureFrame$(0);
    P.Future_Future$delayed(C.Duration_1000000, new F.main_closure(frame), null);
    t1 = J.get$onClick$x(document.querySelector("#replay"));
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new F.main_closure0(frame)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
  }, "call$0", "main$closure", 0, 0, 1],
  main_closure: {
    "^": "Closure:9;frame_0",
    call$0: function() {
      return this.frame_0.demoAnimation$0();
    }
  },
  main_closure0: {
    "^": "Closure:10;frame_1",
    call$1: function(e) {
      return this.frame_1.demoAnimation$0();
    }
  },
  BeforeAndAfterPictureFrame: {
    "^": "Object;isDragging,isDemoInProgress,slider,imageAfter,timeTravelPhoto",
    onSliderMouseMoved$1: [function($event) {
      if (this.isDragging && J.get$button$x($event) === 0) {
        this.setSliderX$1(this.getRelativeX$1($event));
        J.preventDefault$0$x($event);
        $event.stopPropagation();
      }
    }, "call$1", "get$onSliderMouseMoved", 2, 0, 20],
    getRelativeX$1: function($event) {
      var t1, t2;
      t1 = J.get$client$x($event);
      t1 = t1.get$x(t1);
      t2 = this.timeTravelPhoto;
      t2.toString;
      t2 = C.JSNumber_methods.toInt$0(C.JSNumber_methods.roundToDouble$0(t2.offsetLeft));
      if (typeof t1 !== "number")
        return t1.$sub();
      return P.max(0, P.min(494, t1 - t2 - 3));
    },
    setSliderX$1: function(x) {
      J.set$left$x(this.slider.style, "" + x + "px");
      J.set$left$x(this.imageAfter.style, "" + x + "px");
    },
    slideTo$2$delayMs$x: function(delayMs, x) {
      H.IterableMixinWorkaround_forEach([this.slider, this.imageAfter], new F.BeforeAndAfterPictureFrame_slideTo_closure(x, delayMs));
      return P.Future_Future$delayed(P.Duration$(0, 0, 0, delayMs + 1000, 0, 0), new F.BeforeAndAfterPictureFrame_slideTo_closure0(this), null);
    },
    slideTo$1$x: function(x) {
      return this.slideTo$2$delayMs$x(0, x);
    },
    demoAnimation$0: function() {
      if (this.isDemoInProgress)
        return;
      this.isDemoInProgress = true;
      this.slideTo$2$delayMs$x(800, 500).then$1(new F.BeforeAndAfterPictureFrame_demoAnimation_closure(this));
    },
    BeforeAndAfterPictureFrame$1$x: function(x) {
      var t1, t2, t3;
      this.imageAfter = document.querySelector("#image-after");
      t1 = document.querySelector("#slider");
      J.set$width$x(t1.style, "6px");
      t2 = J.get$onMouseDown$x(t1);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new F.BeforeAndAfterPictureFrame_closure(this)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
      this.slider = t1;
      t1 = document.querySelector("#photo-frame");
      t2 = J.getInterceptor$x(t1);
      t3 = t2.get$onMouseMove(t1);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t3._target, t3._eventType, W._wrapZone(this.get$onSliderMouseMoved()), t3._useCapture), [H.getTypeArgumentByIndex(t3, 0)])._tryResume$0();
      t3 = t2.get$onMouseUp(t1);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t3._target, t3._eventType, W._wrapZone(new F.BeforeAndAfterPictureFrame_closure0(this)), t3._useCapture), [H.getTypeArgumentByIndex(t3, 0)])._tryResume$0();
      t2 = t2.get$onClick(t1);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new F.BeforeAndAfterPictureFrame_closure1(this)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
      this.timeTravelPhoto = t1;
      this.setSliderX$1(x);
    },
    static: {"^": "BeforeAndAfterPictureFrame_IMAGE_WIDTH,BeforeAndAfterPictureFrame_IMAGE_HEIGHT,BeforeAndAfterPictureFrame_SLIDER_WIDTH,BeforeAndAfterPictureFrame_ANIMATION", BeforeAndAfterPictureFrame$: function(x) {
        var t1 = new F.BeforeAndAfterPictureFrame(false, false, null, null, null);
        t1.BeforeAndAfterPictureFrame$1$x(x);
        return t1;
      }}
  },
  BeforeAndAfterPictureFrame_closure: {
    "^": "Closure:10;this_0",
    call$1: function(e) {
      this.this_0.isDragging = true;
      return true;
    }
  },
  BeforeAndAfterPictureFrame_closure0: {
    "^": "Closure:10;this_1",
    call$1: function(e) {
      this.this_1.isDragging = false;
      return false;
    }
  },
  BeforeAndAfterPictureFrame_closure1: {
    "^": "Closure:10;this_2",
    call$1: function(e) {
      var t1 = this.this_2;
      return t1.slideTo$1$x(t1.getRelativeX$1(e));
    }
  },
  BeforeAndAfterPictureFrame_slideTo_closure: {
    "^": "Closure:21;x_0,delayMs_1",
    call$1: function(element) {
      var t1;
      J.get$classes$x(element).add$1(0, "animated-left");
      t1 = element.style;
      J.getInterceptor$x(t1).set$left(t1, "" + this.x_0 + ".px");
      C.CssStyleDeclaration_methods.set$transitionDelay(t1, "" + this.delayMs_1 + "ms");
    }
  },
  BeforeAndAfterPictureFrame_slideTo_closure0: {
    "^": "Closure:9;this_2",
    call$0: function() {
      var t1 = this.this_2;
      H.IterableMixinWorkaround_forEach([t1.slider, t1.imageAfter], new F.BeforeAndAfterPictureFrame_slideTo__closure());
    }
  },
  BeforeAndAfterPictureFrame_slideTo__closure: {
    "^": "Closure:21;",
    call$1: function(element) {
      J.get$classes$x(element).remove$1(0, "animated-left");
      J.set$transitionDelay$x(element.style, "");
    }
  },
  BeforeAndAfterPictureFrame_demoAnimation_closure: {
    "^": "Closure:10;this_0",
    call$1: function(result) {
      var t1 = this.this_0;
      return t1.slideTo$2$delayMs$x(800, 0).then$1(new F.BeforeAndAfterPictureFrame_demoAnimation__closure(t1));
    }
  },
  BeforeAndAfterPictureFrame_demoAnimation__closure: {
    "^": "Closure:10;this_1",
    call$1: function(result) {
      var t1 = this.this_1;
      t1.slideTo$2$delayMs$x(800, 166).then$1(new F.BeforeAndAfterPictureFrame_demoAnimation___closure(t1));
    }
  },
  BeforeAndAfterPictureFrame_demoAnimation___closure: {
    "^": "Closure:10;this_2",
    call$1: function(result) {
      this.this_2.isDemoInProgress = false;
      return false;
    }
  }
},
...
function dart_precompiled($collectedClasses) {
  ...
  function main_closure0(frame_1) {
